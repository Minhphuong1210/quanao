...
<aside class="sidebar d-none d-lg-flex flex-column p-3">
    ...
    <nav class="nav flex-column flex-grow-1">
        <a class="nav-link  <?= (strpos($_SERVER['REQUEST_URI'], 'admin') === 0 && !strpos($_SERVER['REQUEST_URI'], '/category') && !strpos($_SERVER['REQUEST_URI'], '/product')) ? 'active' : '' ?>"
            href="/admin" >
        ...
        <a class="nav-link  <?= (strpos($_SERVER['REQUEST_URI'], 'admin/nha-cung-cap') !== false) ? 'active' : '' ?>"
            href="/admin/nha_cung_cap" >
            <i class="fas fa-cog me-2"></i> Nhà cung cấp
        </a>

        <a class="nav-link  <?= (strpos($_SERVER['REQUEST_URI'], 'admin/size') !== false) ? 'active' : '' ?>"
            href="/admin/sizes" >
        ...
        <a class="nav-link  <?= (strpos($_SERVER['REQUEST_URI'], 'admin/order') !== false) ? 'active' : '' ?>"
            href="/admin/order" >
            <i class="fas fa-shopping-cart me-2"></i> Đơn hàng
        </a>

        <a class="nav-link  <?= (strpos($_SERVER['REQUEST_URI'], 'admin/category-post') !== false) ? 'active' : '' ?>"
            href="/admin/category-post">
            <i class="fas fa-tags me-2"></i> danh mục bài viết 
        </a>

        <a class="nav-link  <?= (strpos($_SERVER['REQUEST_URI'], 'admin/category-post') !== false) ? 'active' : '' ?>"
            href="/admin/post">
            <i class="fas fa-tags me-2"></i> Baifa viết
        </a>
