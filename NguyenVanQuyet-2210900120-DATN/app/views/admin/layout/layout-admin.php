...
<body class="d-flex flex-column h-100">
    ...
    <main class="main-content flex-grow-1 d-flex flex-column">
        ...
        <div class="content-placeholder flex-grow-1">
            <?= $content ?? '<div class="text-center py-5"><i class="fas fa-spinner fa-spin fa-3x text-primary mb-3"></i><h4>Đang tải nội dung...</h4><p>Chọn một mục từ sidebar để bắt đầu.</p></div>' ?>
        </div>
    </main>
