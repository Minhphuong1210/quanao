...
<main class="main-content flex-grow-1 d-flex flex-column">
    <div class="content-placeholder flex-grow-1">
        ...
        <h4><?= $pageTitle ?? 'Sửa sizes' ?></h4>

        <form method="post" class="w-50 mx-auto"action="<?= BASE_URL ?>admin/sizes/edit/<?= $item['id'] ?>">
            ...
            <div class="text-center">
                ...
                <a href="<?= BASE_URL ?>admin/sizes" class="btn btn-secondary ms-2">
