...
<main class="main-content flex-grow-1 d-flex flex-column">
    <div class="content-placeholder flex-grow-1">
        ...
        <!-- TIÊU ĐỀ -->
        <h4 class="mb-3">Quản lý Kích thước </h4>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
            ...
            <!-- Add user -->
            <a href="<?= BASE_URL ?>admin/sizes/create" class="btn btn-success">
            ...
            <?php else: ?>
                <?php foreach ($items as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASE_URL ?>admin/sizes/edit/<?= $user['id'] ?>" class="text-primary me-2">
                                <i class="fas fa-edit"></i> Sửa
                            </a>
                            <a href="<?= BASE_URL ?>admin/sizes/delete/<?= $user['id'] ?>"
                               class="text-danger"
