...
<head>
    ...
    <title>Quanao Admin - Thêm danh mục bài viết</title>
...
<main class="main-content flex-grow-1 d-flex flex-column">
    ...
    <div class="content-placeholder flex-grow-1">
        ...
        <h4 class="mb-4">Thêm danh mục bài viết</h4>

        <form action="<?= BASE_URL ?>admin/category-post/create" method="post" class="w-50">
            ...
            <!-- Slug -->
            <div class="mb-3">
                <label class="form-label">Slug (không bắt buộc)</label>
