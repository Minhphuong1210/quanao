            ...
            <div class="col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="product-color mb-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php if (!empty($mau_sac)): ?>
                            <?php foreach ($mau_sac as $color): ?>
                                <li>
                                    <div class="product-color-item">
                                        <a href="<?= BASE_URL ?>mau-sac/<?= $color['slug'] ?>"
                                         ...
                                         height:14px;
                                         border-radius:50%;
                                         background: <?= htmlspecialchars($color['ma_mau']) ?>;">
                                            </span>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <li class="text-muted">Không có màu sắc</li>
                        <?php endif; ?>
                    ...
                    <div class="mb-4">
                        ...
                        <ul class="list-unstyled">
                            <?php foreach ($nha_cung_cap as $ncc): ?>
                                <li class="mb-2">
                                    <a href="<?= BASE_URL ?>nha-cung-cap/<?= $ncc['id'] ?>"
                                        class="d-flex align-items-center <?= isset($currentSupplierId) && $currentSupplierId == $ncc['id']
                            ...
                            <li class="mt-2">
                                <a href="<?= BASE_URL ?>tat-ca-san-pham" class="text-muted">
                                    Tất cả sản phẩm
                                </a>
                            </li>
                        </ul>
