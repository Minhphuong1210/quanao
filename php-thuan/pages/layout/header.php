        ...
        <div class="row gx-0 align-items-center text-center">
                ...
                <div class="d-inline-flex align-items-center">
                    <a href="#" class="navbar-brand p-0">
                        <h1 class="display-5 text-primary m-0"><i
                                class="fas fa-shopping-bag text-secondary me-2"></i><a href="/quanao/php-thuan/">Quần Áo</a></h1>
                        <!-- <img src="/quanao/php-thuan/assets/img/no-img.png" alt="Logo"> -->
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a href="/quanao/php-thuan/views/user/cart/" class="text-muted d-flex align-items-center justify-content-center"><span
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                    <a href="#" class="navbar-brand d-block d-lg-none">
                        <h1 class="display-5 text-secondary m-0"><i
                                class="fas fa-shopping-bag text-white me-2"></i><a href="/quanao/php-thuan/"></a></h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav w-100 d-flex justify-content-evenly py-0">
                            <a href="index.php?page=home" class="nav-item nav-link active">Trang chủ</a>
                            <a href="index.php?page=allProduct" class="nav-item nav-link">Sản phẩm</a>
                            <div class="nav-item dropdown">
                                <a href="#!" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Các trang</a>
                                <div class="dropdown-menu m-0">
                                    <a href="bestseller.html" class="dropdown-item">Sản phẩm bán chạy</a>
                        ...
                        <a href="#" class="btn btn-secondary rounded-3 py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0">
